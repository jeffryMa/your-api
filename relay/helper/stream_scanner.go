...
func StreamScannerHandlerWithDoneCallback(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo, dataHandler func(data string) bool, doneHandler func()) {
